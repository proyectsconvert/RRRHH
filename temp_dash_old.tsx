...
const Dashboard = () => {
    ...
    try {
      ...
      setStats([
        {
          ...
          icon: Users,
          trend: { value: 12, isPositive: true }, // Valor est├ítico por ahora
        },
        {
          title: 'Vacantes Activas',
          value: activeJobsCount || 0,
          icon: File,
          trend: { value: 5, isPositive: true }, // Valor est├ítico por ahora
        },
        {
          title: 'Entrevistas Programadas',
          value: interviewsCount || 0,
          icon: Calendar,
          trend: { value: 3, isPositive: false }, // Valor est├ítico por ahora
        },
        {
          title: 'Contrataciones este Mes',
          value: hiresCount || 0,
          icon: User,
          trend: { value: 25, isPositive: true }, // Valor est├ítico por ahora
        },
      ]);
      ...
      try {
        ...
        const { data: popularJobsData, error: popularJobsError } = await supabase
          .from('jobs')  // Cambio: usamos jobs directamente en lugar de la funci├│n RPC
      ...
      // Cargar datos para el gr├ífico de aplicaciones por estado
      ...
      // Convertir a formato para el gr├ífico
  ...
  useEffect(() => {
    ...
    // Configurar suscripci├│n en tiempo real para cambios en las tablas
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border">
            <div className="flex items-center justify-between">
              ...
              <div className="h-8 w-8 bg-green-100 rounded-full flex items-center justify-center">
                <span className="text-green-600 font-semibold">Ôêæ</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border">
            <div className="flex items-center justify-between">
              ...
              <div className="h-8 w-8 bg-orange-100 rounded-full flex items-center justify-center">
                <span className="text-orange-600 font-semibold">ÔÜí</span>
              </div>
            </div>
          </div>
        </div>
